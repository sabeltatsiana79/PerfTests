...
module.exports = {
    ...
    audits: [
        path.join(process.cwd(), './settings/custom-network-requests'),
        path.join(process.cwd(), './settings/custom-network-server-latency'),
        //'network-requests',
        'network-rtt',
        //'network-server-latency',
        path.join(process.cwd(), './settings/custom-main-thread-tasks'),
        'metrics',
        'performance-budget',
        'timing-budget',
        'full-page-screenshot',
        ...
        //'final-screenshot',
        path.join(process.cwd(), './settings/custom-final-screenshot'),
    ],
